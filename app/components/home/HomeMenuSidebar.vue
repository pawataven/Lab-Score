...
<template>
  <div class="bg-white rounded-xl border border-gray-100 p-4 pb-[30%] shadow-sm">
    ...
    <div class="relative mb-4">
      ...
      />
      <svg
        class="w-4 h-4 text-gray-500 absolute left-3 top-4"
        fill="none"
        stroke="currentColor"
        viewBox="0 0 24 24"
      >
    ...
    <div class="space-y-1">
      ...
      >
        ...
        <div
          class="h-5 w-5 flex items-center justify-center rounded border-2 border-gray-300 bg-white transition-all duration-200
                 peer-checked:border-[#f97316] peer-checked:bg-[#f97316] peer-checked:[&_svg]:scale-100"
        >
          <svg
            class="h-3.5 w-3.5 text-white transform scale-0 transition-transform duration-200"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
            stroke-width="3"
        ...
        <div class="flex items-center space-x-2 text-text-primary">
          ...
          <img v-else :src="league.logo" class="w-6 h-6 rounded-full object-contain" />
